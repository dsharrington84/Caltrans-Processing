...
def main():
    ...
    with duckdb.connect(str(DB_PATH)) as con:
        ...
        con.execute("""
        DROP TABLE IF EXISTS contractor_competitor_matrix
        """)

        con.execute("""
        CREATE TABLE contractor_competitor_matrix AS
        ...
        FROM contractor_bid_history a

        JOIN contractor_bid_history b
    ...
    print("Competitor matrix created.")
