...
def main():
    ...
    with duckdb.connect(str(DB_PATH)) as con:
        ...
        con.execute("""
        DROP TABLE IF EXISTS contractor_intelligence_dashboard
        """)

        con.execute("""
        CREATE TABLE contractor_intelligence_dashboard AS
        ...
        FROM contractor_performance_summary p

        LEFT JOIN contractor_competitor_summary c
    ...
    print("Contractor intelligence dashboard created.")
