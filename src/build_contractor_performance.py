...
def main():
    ...
    with duckdb.connect(str(DB_PATH)) as con:
        ...
        con.execute("""
        DROP TABLE IF EXISTS contractor_performance_summary
        """)

        con.execute("""
        CREATE TABLE contractor_performance_summary AS
    ...
    print("Contractor performance summary created.")
